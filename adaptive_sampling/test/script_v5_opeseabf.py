...
config_fixed_sigma = False          # Disable bandwidth rescaling and use input std for all kernels
...
def print_output(the_md,the_bias):
    print("%11.2f\t%14.6f\t%14.6f\t%14.6f\t%14.6f\t%14.6f\t%14.6f\t%14d\t%14.6f" % (
...
print(
    ...
    % ("time [fs]", "x", "y", "lamda", "E_pot", "E_kin", "Temp", "# kernels", "bias pot")
)
