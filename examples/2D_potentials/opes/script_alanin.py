...
collective_var = [["torsion", cv_atoms_phi, minimum, maximum, bin_width], ["torsion", cv_atoms_psi, minimum, maximum, bin_width]]

periodicity = [[-np.pi, np.pi], [-np.pi, np.pi]]

# ------------------------------------------------------------------------------------
# Setup OpenMM
prmtop = AmberPrmtopFile(f"/home/rschiller/Code/adaptive_sampling/tutorials/data/alanine-dipeptide.prmtop")
crd = AmberInpcrdFile(f"/home/rschiller/Code/adaptive_sampling/tutorials/data/alanine-dipeptide.crd")
